...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            ...
            default_value="",
            description="Kinematics YAML file holding this robot's measured parameters, as generated by flexiv_calibration. Defaults to flexiv_description/config/[robot_type]/default_kinematics.yaml. One file describes the whole robot, including both arms of a dual-arm model.",
        )
    )
