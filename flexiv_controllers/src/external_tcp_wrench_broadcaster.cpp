...
CallbackReturn ExternalTcpWrenchBroadcaster::on_init()
{
    try {
    ...
    const rclcpp_lifecycle::State& /*previous_state*/)
{
    ...
    if (topic_name_.empty()) {
        RCLCPP_ERROR(get_node()->get_logger(), "'topic_name' parameter has to be provided.");
        return CallbackReturn::ERROR;
    }
...
PLUGINLIB_EXPORT_CLASS(
    flexiv_controllers::ExternalTcpWrenchBroadcaster, controller_interface::ControllerInterface)
