...
{
    // Host both nodes on the controller manager's executor, so that all blocking system control
    // calls happen off the real-time control loop without needing a thread here.
