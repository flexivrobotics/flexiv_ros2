# """
# Launch file for RDK State Publisher Node

# Example usage:
#     ros2 launch flexiv_test_nodes rdk_state_publisher.launch.py robot_sn:=Rizon4s-123456 network_interface:=eth0
    
#     Or to use all available network interfaces:
#     ros2 launch flexiv_test_nodes rdk_state_publisher.launch.py robot_sn:=Rizon4s-123456
# """
...
#     """Generate launch description for RDK State Publisher"""
    
#     # Declare launch arguments
#     robot_sn_arg = DeclareLaunchArgument(
#         'robot_sn',
#         description='Robot serial number (e.g., Rizon4s-123456)'
#     )
    
#     network_interface_arg = DeclareLaunchArgument(
#         'network_interface',
#         default_value='',
#         description='Network interface name (e.g., eth0, enp0s31f6). Leave empty to use all interfaces.'
#     )
...
#     # Create the RDK State Publisher node
#     rdk_state_publisher_node = Node(
...
#         }],
#         arguments=[
#             '--robot-sn', LaunchConfiguration('robot_sn'),
