...
from geometry_msgs.msg import Pose, Accel, Wrench
...
class RobotStatesPublisher(Node):
    ...
    def create_pose_stamped(self, pose_data, frame_id='world'):
        """
        Convert RDK pose data [x, y, z, q_w, q_x, q_y, q_z] to PoseStamped
        """
    ...
    def create_wrench_stamped(self, wrench_data, frame_id):
        """
        Convert RDK wrench data [f_x, f_y, f_z, m_x, m_y, m_z] to WrenchStamped
        """
